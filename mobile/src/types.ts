 ...
 *
 * This file is a verbatim copy of frontend/src/types.ts — it is plain TypeScript
 * with no DOM dependency, so the web client and this mobile client share one
 * data model. Keep the two in sync; if the backend contract changes, change
 * BOTH files.
 *
 * Field names match the actual table columns
